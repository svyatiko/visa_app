...
class TestPages(unittest.TestCase):
    def setUp(self):
        self.response_visa_center = requests.get("http://127.0.0.1:5050/lva'")
        self.response_embassy = requests.get("http://127.0.0.1:5050/ltu'")
        self.response_consulate = requests.get("http://127.0.0.1:5050/pol'")
        self.response_info = requests.get("http://127.0.0.1:5050/esp'")

        self.response_info = requests.get("http://127.0.0.1:5050/tha'")
        self.response_info = requests.get("http://127.0.0.1:5050/aut'")
