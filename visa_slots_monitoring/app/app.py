...
def get_from_es(country):
    ...
    result = es.search(index="appointment", query={"match": {"country": country}})
    result_list = {country: []}
...
def home():
    return (
        '<a class="button" href="/lva">Latvia</a>'
        "<br>"
        '<a class="button" href="/aut">Austria</a>'
        "<br>"
        '<a class="button" href="/ltu">Lithuania</a>'
        "<br>"
        '<a class="button" href="/pol">Poland</a>'
        "<br>"
        '<a class="button" href="/esp">Spain</a>'
        "<br>"
        '<a class="button" href="/nor">Norway</a>'
        "<br>"
